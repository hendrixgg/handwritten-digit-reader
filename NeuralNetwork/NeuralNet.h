...
namespace std {
    class NeuralNet {
        ...
        double static f(double z) { return 1.0 / (1 + exp(-z)); };
        void setStructure(const vector<int>& dimensions);
    public:
        ...
        vector<vector<double>> value; // value of a node v[L][i] = value of the i-th node on the L-th layer
        ...
        */
        ...
        double error(const vector<double>& expected);
    };
}